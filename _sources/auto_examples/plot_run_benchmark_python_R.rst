...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /home/circleci/project/benchopt/base.py:71: FutureWarning: 'stopping_strategy' attribute is deprecated and will be removed in benchopt 1.5, use 'sampling_strategy' instead.
      warnings.warn(
        |--Python-PGD[use_acceleration=False]: done
    /home/circleci/project/benchopt/base.py:109: FutureWarning: Skipping sparse X via `support_sparse = False` is deprecated and will be removed in v 1.5. Skip explicitly using `Solver.skip`.
      warnings.warn(
        |--R-PGD: done (timeout)
    Saving result in: /home/circleci/project/benchmarks/benchmark_lasso/outputs/benchopt_run_2023-07-19_14h53m28.parquet
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 2 minutes  15.634 seconds)
