...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /home/circleci/project/benchopt/base.py:109: FutureWarning: Skipping sparse X via `support_sparse = False` is deprecated and will be removed in v 1.5. Skip explicitly using `Solver.skip`.
      warnings.warn(
        |--R-PGD: done (timeout)
    Saving result in: /home/circleci/project/benchmarks/benchmark_lasso/outputs/benchopt_run_2023-07-19_10h16m30.parquet
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 2 minutes  14.609 seconds)
