...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_dpilxghm/julia_solver<span class="w"> </span>-s<span class="w"> </span>julia-gd
    </pre></div>
    </pre>
    ...
    julia-1.12.5         | 165.2 MB  | 6          |   6% [A
    perl-5.32.1          | 12.7 MB   | #5         |  16% 

    git-2.54.0           | 11.0 MB   | 9          |  10% 


    openblas-ilp64-0.3.3 | 5.7 MB    | 4          |   5% 



    libopenblas-ilp64-0. | 5.5 MB    | 6          |   6% 
    perl-5.32.1          | 12.7 MB   | #####9     |  60% 
    ...
    &#x27;install&#x27;, &#x27;-U&#x27;, &#x27;-r&#x27;, &#x27;/tmp/condaenv.3j7ek8wa.requirements.txt&#x27;, 
    &#x27;--exists-action=b&#x27;]
    Pip subprocess output:
    Collecting julia (from -r /tmp/condaenv.3j7ek8wa.requirements.txt (line 1))
    ...
    temp_benchmark_dpilxghm/julia_solver/solvers/julia_gd.py. Please fix the 
    ...
    _get_module_from_file
      ...
      File 
    &quot;/home/circleci/project/examples/temp_benchmark_dpilxghm/julia_solver/solvers/
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_dpilxghm/julia_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_dpilxghm/julia_solver/outputs/benchopt_run_2026-06-11_07h51m13.</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_dpilxghm/julia_solver/outputs/benchopt_run_2026-06-11_07h51m13.
    parquet
    done
    Writing results to 
    temp_benchmark_dpilxghm/julia_solver/outputs/julia_solver_benchopt_run_2026-06
    -11_07h51m13.html
    Writing julia_solver index to 
    temp_benchmark_dpilxghm/julia_solver/outputs/julia_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (3 minutes 40.816 seconds)
