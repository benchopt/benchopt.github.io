...
.. raw:: html
    ...
    <input  id='example-benchmark-75a208d246264ca3b3a9aa5d21c4cb95-1' name='example-benchmark-75a208d246264ca3b3a9aa5d21c4cb95' type='radio'><label for='example-benchmark-75a208d246264ca3b3a9aa5d21c4cb95-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-75a208d246264ca3b3a9aa5d21c4cb95-2' name='example-benchmark-75a208d246264ca3b3a9aa5d21c4cb95' type='radio'><label for='example-benchmark-75a208d246264ca3b3a9aa5d21c4cb95-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-75a208d246264ca3b3a9aa5d21c4cb95-3' name='example-benchmark-75a208d246264ca3b3a9aa5d21c4cb95' type='radio'><label for='example-benchmark-75a208d246264ca3b3a9aa5d21c4cb95-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark__gs04leu/julia_solver<span class="w"> </span>-s<span class="w"> </span>julia-gd
    </pre></div>
    </pre>
    ...
    perl-5.32.1          | 12.7 MB   | ###        |  30% 

    git-2.54.0           | 11.0 MB   | #9         |  19% 



    libopenblas-ilp64-0. | 5.5 MB    | ####5      |  46% 


    julia-1.12.5         | 165.2 MB  | 2          |   3% 
    perl-5.32.1          | 12.7 MB   | #######8   |  78% 

    git-2.54.0           | 11.0 MB   | #######7   |  77% 
    ...
    openblas-ilp64-0.3.3 | 5.7 MB    | ######6    |  67% 
    ...
    &#x27;install&#x27;, &#x27;-U&#x27;, &#x27;-r&#x27;, &#x27;/tmp/condaenv.hg2tm8qz.requirements.txt&#x27;, 
    &#x27;--exists-action=b&#x27;]
    Pip subprocess output:
    Collecting julia (from -r /tmp/condaenv.hg2tm8qz.requirements.txt (line 1))
    ...
    temp_benchmark__gs04leu/julia_solver/solvers/julia_gd.py. Please fix the 
    ...
    _get_module_from_file
      ...
      File 
    &quot;/home/circleci/project/examples/temp_benchmark__gs04leu/julia_solver/solvers/
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark__gs04leu/julia_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark__gs04leu/julia_solver/outputs/benchopt_run_2026-06-22_20h27m19.</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark__gs04leu/julia_solver/outputs/benchopt_run_2026-06-22_20h27m19.
    parquet
    done
    Writing results to 
    temp_benchmark__gs04leu/julia_solver/outputs/julia_solver_benchopt_run_2026-06
    -22_20h27m19.html
    Writing julia_solver index to 
    temp_benchmark__gs04leu/julia_solver/outputs/julia_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (4 minutes 33.769 seconds)
