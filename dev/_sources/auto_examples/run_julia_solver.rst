...
.. raw:: html
    ...
    <input  id='example-benchmark-1403a74fe62a4b12a3435dc79986939c-1' name='example-benchmark-1403a74fe62a4b12a3435dc79986939c' type='radio'><label for='example-benchmark-1403a74fe62a4b12a3435dc79986939c-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-1403a74fe62a4b12a3435dc79986939c-2' name='example-benchmark-1403a74fe62a4b12a3435dc79986939c' type='radio'><label for='example-benchmark-1403a74fe62a4b12a3435dc79986939c-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-1403a74fe62a4b12a3435dc79986939c-3' name='example-benchmark-1403a74fe62a4b12a3435dc79986939c' type='radio'><label for='example-benchmark-1403a74fe62a4b12a3435dc79986939c-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_efgs3th0/julia_solver<span class="w"> </span>-s<span class="w"> </span>julia-gd
    </pre></div>
    </pre>
    ...
    git-2.54.0           | 10.8 MB   | ##3        |  24% 



    libopenblas-ilp64-0. | 5.5 MB    | ##4        |  25% 


    julia-1.12.5         | 165.2 MB  | 5          |   6% 
    perl-5.32.1          | 12.7 MB   | ######3    |  63% 

    git-2.54.0           | 10.8 MB   | ########   |  81% 
    ...
    &#x27;install&#x27;, &#x27;-U&#x27;, &#x27;-r&#x27;, &#x27;/tmp/condaenv.acpaad2g.requirements.txt&#x27;, 
    &#x27;--exists-action=b&#x27;]
    Pip subprocess output:
    Collecting julia (from -r /tmp/condaenv.acpaad2g.requirements.txt (line 1))
    ...
    temp_benchmark_efgs3th0/julia_solver/solvers/julia_gd.py. Please fix the 
    ...
    _get_module_from_file
      ...
      File 
    &quot;/home/circleci/project/examples/temp_benchmark_efgs3th0/julia_solver/solvers/
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_efgs3th0/julia_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_efgs3th0/julia_solver/outputs/benchopt_run_2026-05-11_12h59m26.</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_efgs3th0/julia_solver/outputs/benchopt_run_2026-05-11_12h59m26.
    parquet
    done
    Writing results to 
    temp_benchmark_efgs3th0/julia_solver/outputs/julia_solver_benchopt_run_2026-05
    -11_12h59m26.html
    Writing julia_solver index to 
    temp_benchmark_efgs3th0/julia_solver/outputs/julia_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (4 minutes 16.960 seconds)
