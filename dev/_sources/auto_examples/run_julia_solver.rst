...
.. raw:: html
    ...
    <input  id='example-benchmark-1342b44efe97434c9fa54938b1c37a34-1' name='example-benchmark-1342b44efe97434c9fa54938b1c37a34' type='radio'><label for='example-benchmark-1342b44efe97434c9fa54938b1c37a34-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-1342b44efe97434c9fa54938b1c37a34-2' name='example-benchmark-1342b44efe97434c9fa54938b1c37a34' type='radio'><label for='example-benchmark-1342b44efe97434c9fa54938b1c37a34-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-1342b44efe97434c9fa54938b1c37a34-3' name='example-benchmark-1342b44efe97434c9fa54938b1c37a34' type='radio'><label for='example-benchmark-1342b44efe97434c9fa54938b1c37a34-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='julia_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-9e107c7932e14c2db28d30a6bca6a0d7-0' name='example-benchmark-9e107c7932e14c2db28d30a6bca6a0d7' type='radio'><label for='example-benchmark-9e107c7932e14c2db28d30a6bca6a0d7-0'>solvers/julia_gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-9e107c7932e14c2db28d30a6bca6a0d7-1' name='example-benchmark-9e107c7932e14c2db28d30a6bca6a0d7' type='radio'><label for='example-benchmark-9e107c7932e14c2db28d30a6bca6a0d7-1'>solvers/julia_gd.jl</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="k">using</span><span class="w"> </span><span class="n">Core</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_d6yar0va/julia_solver<span class="w"> </span>-s<span class="w"> </span>julia-gd
    </pre></div>
    </pre>
    ...
    perl-5.32.1          | 12.7 MB   | ###9       |  39% 

    git-2.54.0           | 10.8 MB   | ##         |  21% 


    openblas-ilp64-0.3.3 | 5.7 MB    | 9          |  10% 



    julia-1.12.5         | 165.2 MB  | 5          |   6% 
    perl-5.32.1          | 12.7 MB   | #########8 |  98% 



    libopenblas-ilp64-0. | 5.5 MB    | ########## | 100% 

    git-2.54.0           | 10.8 MB   | #########1 |  92% 


    openblas-ilp64-0.3.3 | 5.7 MB    | ########5  |  86% 
    ...
    julia-1.12.5         | 165.2 MB  | ##2        |  22% [A




    julia-1.12.5         | 165.2 MB  | ##7        |  27% 
    ...
    &#x27;install&#x27;, &#x27;-U&#x27;, &#x27;-r&#x27;, &#x27;/tmp/condaenv.qtnkbb2c.requirements.txt&#x27;, 
    &#x27;--exists-action=b&#x27;]
    Pip subprocess output:
    Collecting julia (from -r /tmp/condaenv.qtnkbb2c.requirements.txt (line 1))
    ...
    temp_benchmark_d6yar0va/julia_solver/solvers/julia_gd.py. Please fix the 
    ...
    _get_module_from_file
      ...
      File 
    &quot;/home/circleci/project/examples/temp_benchmark_d6yar0va/julia_solver/solvers/
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_d6yar0va/julia_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_d6yar0va/julia_solver/outputs/benchopt_run_2026-06-05_14h00m00.</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_d6yar0va/julia_solver/outputs/benchopt_run_2026-06-05_14h00m00.
    parquet
    done
    Writing results to 
    temp_benchmark_d6yar0va/julia_solver/outputs/julia_solver_benchopt_run_2026-06
    -05_14h00m00.html
    Writing julia_solver index to 
    temp_benchmark_d6yar0va/julia_solver/outputs/julia_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (4 minutes 20.368 seconds)
