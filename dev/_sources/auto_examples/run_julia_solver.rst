...
.. raw:: html
    ...
    <input  id='example-benchmark-d50a553c25124a6899259c2495a80892-1' name='example-benchmark-d50a553c25124a6899259c2495a80892' type='radio'><label for='example-benchmark-d50a553c25124a6899259c2495a80892-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-d50a553c25124a6899259c2495a80892-2' name='example-benchmark-d50a553c25124a6899259c2495a80892' type='radio'><label for='example-benchmark-d50a553c25124a6899259c2495a80892-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-d50a553c25124a6899259c2495a80892-3' name='example-benchmark-d50a553c25124a6899259c2495a80892' type='radio'><label for='example-benchmark-d50a553c25124a6899259c2495a80892-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='julia_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-38bd6548b9284fe9b1aa02b067c99fdf-0' name='example-benchmark-38bd6548b9284fe9b1aa02b067c99fdf' type='radio'><label for='example-benchmark-38bd6548b9284fe9b1aa02b067c99fdf-0'>solvers/julia_gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-38bd6548b9284fe9b1aa02b067c99fdf-1' name='example-benchmark-38bd6548b9284fe9b1aa02b067c99fdf' type='radio'><label for='example-benchmark-38bd6548b9284fe9b1aa02b067c99fdf-1'>solvers/julia_gd.jl</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="k">using</span><span class="w"> </span><span class="n">Core</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_gd2cpc81/julia_solver<span class="w"> </span>-s<span class="w"> </span>julia-gd
    </pre></div>
    </pre>
    ...
    julia-1.12.7         | 168.5 MB  | 1          |   2% [A
    perl-5.32.1          | 12.7 MB   | #7         |  17% 

    git-2.55.0           | 11.1 MB   | ##7        |  27% 


    openblas-ilp64-0.3.3 | 5.6 MB    | ####7      |  47% 



    libopenblas-ilp64-0. | 5.6 MB    | #####3     |  54% 



    julia-1.12.7         | 168.5 MB  | 5          |   6% 
    perl-5.32.1          | 12.7 MB   | ####3      |  44% 

    git-2.55.0           | 11.1 MB   | ######6    |  67% 
    ...
    julia-1.12.7         | 168.5 MB  | #6         |  17% [A
     ...
     ... (more hidden) ...
    julia-1.12.7         | 168.5 MB  | #9         |  19% 



    julia-1.12.7         | 168.5 MB  | ###        |  30% 
    ...
    &#x27;install&#x27;, &#x27;-U&#x27;, &#x27;-r&#x27;, &#x27;/tmp/condaenv.ajd8hjvs.requirements.txt&#x27;, 
    &#x27;--exists-action=b&#x27;]
    Pip subprocess output:
    Collecting julia (from -r /tmp/condaenv.ajd8hjvs.requirements.txt (line 1))
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_gd2cpc81/julia_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_gd2cpc81/julia_solver/outputs/benchopt_run_2026-09-01_12h23m20.</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_gd2cpc81/julia_solver/outputs/benchopt_run_2026-09-01_12h23m20.
    parquet
    done
    Writing results to 
    temp_benchmark_gd2cpc81/julia_solver/outputs/julia_solver_benchopt_run_2026-09
    -01_12h23m20.html
    Writing julia_solver index to 
    temp_benchmark_gd2cpc81/julia_solver/outputs/julia_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (5 minutes 33.739 seconds)
