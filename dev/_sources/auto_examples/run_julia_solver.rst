...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_xe0f2ide/julia_solver<span class="w"> </span>-s<span class="w"> </span>julia-gd
    </pre></div>
    </pre>
    ...
    perl-5.32.1          | 12.7 MB   | #1         |  12% 

    git-2.55.0           | 10.4 MB   | 4          |   4% 


    openblas-ilp64-0.3.3 | 5.7 MB    | #          |  11% 
    ...
    git-2.55.0           | 10.4 MB   | ###1       |  32% 


    openblas-ilp64-0.3.3 | 5.7 MB    | ######4    |  65% 
    ...
    &#x27;install&#x27;, &#x27;-U&#x27;, &#x27;-r&#x27;, &#x27;/tmp/condaenv.mfb60yub.requirements.txt&#x27;, 
    &#x27;--exists-action=b&#x27;]
    Pip subprocess output:
    Collecting julia (from -r /tmp/condaenv.mfb60yub.requirements.txt (line 1))
    ...
    temp_benchmark_xe0f2ide/julia_solver/solvers/julia_gd.py. Please fix the 
    ...
    _get_module_from_file
      ...
      File 
    &quot;/home/circleci/project/examples/temp_benchmark_xe0f2ide/julia_solver/solvers/
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_xe0f2ide/julia_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_xe0f2ide/julia_solver/outputs/benchopt_run_2026-07-09_04h05m19.</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_xe0f2ide/julia_solver/outputs/benchopt_run_2026-07-09_04h05m19.
    parquet
    done
    Writing results to 
    temp_benchmark_xe0f2ide/julia_solver/outputs/julia_solver_benchopt_run_2026-07
    -09_04h05m19.html
    Writing julia_solver index to 
    temp_benchmark_xe0f2ide/julia_solver/outputs/julia_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (6 minutes 30.015 seconds)
