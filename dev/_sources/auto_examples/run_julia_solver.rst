...
.. raw:: html
    ...
    <input  id='example-benchmark-5d8ff073029d4d0b864ec3df836807be-1' name='example-benchmark-5d8ff073029d4d0b864ec3df836807be' type='radio'><label for='example-benchmark-5d8ff073029d4d0b864ec3df836807be-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-5d8ff073029d4d0b864ec3df836807be-2' name='example-benchmark-5d8ff073029d4d0b864ec3df836807be' type='radio'><label for='example-benchmark-5d8ff073029d4d0b864ec3df836807be-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-5d8ff073029d4d0b864ec3df836807be-3' name='example-benchmark-5d8ff073029d4d0b864ec3df836807be' type='radio'><label for='example-benchmark-5d8ff073029d4d0b864ec3df836807be-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <input  id='example-benchmark-fc561f5779944a4aa3aad92156c7127a-1' name='example-benchmark-fc561f5779944a4aa3aad92156c7127a' type='radio'><label for='example-benchmark-fc561f5779944a4aa3aad92156c7127a-1'>solvers/julia_gd.jl</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="k">using</span><span class="w"> </span><span class="n">Core</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_ocudzq7f/julia_solver<span class="w"> </span>-s<span class="w"> </span>julia-gd
    </pre></div>
    </pre>
    ...
    git-2.54.0           | 11.0 MB   | ######     |  60% 


    openblas-ilp64-0.3.3 | 5.7 MB    | #####2     |  52% 



    libopenblas-ilp64-0. | 5.5 MB    | ##1        |  21% 
    ...
    &#x27;install&#x27;, &#x27;-U&#x27;, &#x27;-r&#x27;, &#x27;/tmp/condaenv.orhlcokc.requirements.txt&#x27;, 
    &#x27;--exists-action=b&#x27;]
    Pip subprocess output:
    Collecting julia (from -r /tmp/condaenv.orhlcokc.requirements.txt (line 1))
    ...
    temp_benchmark_ocudzq7f/julia_solver/solvers/julia_gd.py. Please fix the 
    ...
    _get_module_from_file
      ...
      File 
    &quot;/home/circleci/project/examples/temp_benchmark_ocudzq7f/julia_solver/solvers/
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_ocudzq7f/julia_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_ocudzq7f/julia_solver/outputs/benchopt_run_2026-06-22_07h23m05.</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_ocudzq7f/julia_solver/outputs/benchopt_run_2026-06-22_07h23m05.
    parquet
    done
    Writing results to 
    temp_benchmark_ocudzq7f/julia_solver/outputs/julia_solver_benchopt_run_2026-06
    -22_07h23m05.html
    Writing julia_solver index to 
    temp_benchmark_ocudzq7f/julia_solver/outputs/julia_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (3 minutes 52.136 seconds)
