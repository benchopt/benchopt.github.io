...
.. raw:: html
    ...
    <input  id='example-benchmark-e47eb2ea75bd42c7a6ff655222525e9b-1' name='example-benchmark-e47eb2ea75bd42c7a6ff655222525e9b' type='radio'><label for='example-benchmark-e47eb2ea75bd42c7a6ff655222525e9b-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-e47eb2ea75bd42c7a6ff655222525e9b-2' name='example-benchmark-e47eb2ea75bd42c7a6ff655222525e9b' type='radio'><label for='example-benchmark-e47eb2ea75bd42c7a6ff655222525e9b-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-e47eb2ea75bd42c7a6ff655222525e9b-3' name='example-benchmark-e47eb2ea75bd42c7a6ff655222525e9b' type='radio'><label for='example-benchmark-e47eb2ea75bd42c7a6ff655222525e9b-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='julia_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-29bbf948a45647a6be1d5abd4374362d-0' name='example-benchmark-29bbf948a45647a6be1d5abd4374362d' type='radio'><label for='example-benchmark-29bbf948a45647a6be1d5abd4374362d-0'>solvers/julia_gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-29bbf948a45647a6be1d5abd4374362d-1' name='example-benchmark-29bbf948a45647a6be1d5abd4374362d' type='radio'><label for='example-benchmark-29bbf948a45647a6be1d5abd4374362d-1'>solvers/julia_gd.jl</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="k">using</span><span class="w"> </span><span class="n">Core</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_bmyeq6t_/julia_solver<span class="w"> </span>-s<span class="w"> </span>julia-gd
    </pre></div>
    </pre>
    ...
    julia-1.12.6         | 168.1 MB  |            |   1% [A
    perl-5.32.1          | 12.7 MB   | #7         |  17% 

    git-2.55.0           | 11.1 MB   | #4         |  15% 


    openblas-ilp64-0.3.3 | 5.6 MB    | ###        |  31% 



    julia-1.12.6         | 168.1 MB  | 3          |   3% 
    perl-5.32.1          | 12.7 MB   | ####4      |  45% 

    git-2.55.0           | 11.1 MB   | #####4     |  54% 


    openblas-ilp64-0.3.3 | 5.6 MB    | #########6 |  97% 
    ...
    julia-1.12.6         | 168.1 MB  | 6          |   7% 
    perl-5.32.1          | 12.7 MB   | ########5  |  85% 

    git-2.55.0           | 11.1 MB   | #########8 |  99% 
    ...
    julia-1.12.6         | 168.1 MB  | ##4        |  25% [A



    julia-1.12.6         | 168.1 MB  | ###5       |  35% 




    julia-1.12.6         | 168.1 MB  | ####       |  40% 
    ...
    &#x27;install&#x27;, &#x27;-U&#x27;, &#x27;-r&#x27;, &#x27;/tmp/condaenv._l8p7bbx.requirements.txt&#x27;, 
    &#x27;--exists-action=b&#x27;]
    Pip subprocess output:
    Collecting julia (from -r /tmp/condaenv._l8p7bbx.requirements.txt (line 1))
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_bmyeq6t_/julia_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_bmyeq6t_/julia_solver/outputs/benchopt_run_2026-08-11_09h10m59.</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_bmyeq6t_/julia_solver/outputs/benchopt_run_2026-08-11_09h10m59.
    parquet
    done
    Writing results to 
    temp_benchmark_bmyeq6t_/julia_solver/outputs/julia_solver_benchopt_run_2026-08
    -11_09h10m59.html
    Writing julia_solver index to 
    temp_benchmark_bmyeq6t_/julia_solver/outputs/julia_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (5 minutes 18.556 seconds)
