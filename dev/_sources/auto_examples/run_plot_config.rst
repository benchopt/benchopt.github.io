...
.. raw:: html
    ...
    <input  id='example-benchmark-976bb6c6ce9f41b8999cbf49cb33676f-1' name='example-benchmark-976bb6c6ce9f41b8999cbf49cb33676f' type='radio'><label for='example-benchmark-976bb6c6ce9f41b8999cbf49cb33676f-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-976bb6c6ce9f41b8999cbf49cb33676f-2' name='example-benchmark-976bb6c6ce9f41b8999cbf49cb33676f' type='radio'><label for='example-benchmark-976bb6c6ce9f41b8999cbf49cb33676f-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_m2zpzw2k/minimal_benchmark<span class="w"> </span>-n<span class="w"> </span><span class="m">40</span><span class="w"> </span>-r<span class="w"> </span><span class="m">2</span><span class="w"> </span>-s<span class="w"> </span>gd<span class="o">[</span><span class="nv">lr</span><span class="o">=[</span>1e-1,3e-2,1e-2,3e-3<span class="o">]]</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_m2zpzw2k/minimal_benchmark/outputs/benchopt_run_2026-09-21_12h0</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">5m16.parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_m2zpzw2k/minimal_benchmark/outputs/benchopt_run_2026-09-21_12h0
    5m16.parquet
    done
    Writing results to 
    temp_benchmark_m2zpzw2k/minimal_benchmark/outputs/minimal_benchmark_benchopt_r
    un_2026-09-21_12h05m16.html
    Writing minimal_benchmark index to 
    temp_benchmark_m2zpzw2k/minimal_benchmark/outputs/minimal_benchmark.html
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='minimal_benchmark.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-bff43f2b3771434d909e29caf2b0502b-0' name='example-benchmark-bff43f2b3771434d909e29caf2b0502b' type='radio'><label for='example-benchmark-bff43f2b3771434d909e29caf2b0502b-0'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="nt">plot_configs</span><span class="p">:</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>plot<span class="w"> </span>temp_benchmark_m2zpzw2k/minimal_benchmark
    </pre></div>
    </pre>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    <p>We now update the following files:</p><br/>
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='minimal_benchmark.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-396dc79aa1e54c0991a1188a9bbea508-0' name='example-benchmark-396dc79aa1e54c0991a1188a9bbea508' type='radio'><label for='example-benchmark-396dc79aa1e54c0991a1188a9bbea508-0'>plots/custom_objective_time.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BasePlot</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    <p>We now update the following files:</p><br/>
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='minimal_benchmark.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-724aca33a9354b789ef8bb9cce857746-0' name='example-benchmark-724aca33a9354b789ef8bb9cce857746' type='radio'><label for='example-benchmark-724aca33a9354b789ef8bb9cce857746-0'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="nt">plot_configs</span><span class="p">:</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>plot<span class="w"> </span>temp_benchmark_m2zpzw2k/minimal_benchmark<span class="w"> </span>-k<span class="w"> </span>custom_objective_time<span class="w"> </span>--no-html
    </pre></div>
    </pre>
            
                <div class="sphx-glr-script-out highlight-none notranslate">
                    <div class="highlight"><pre>Save custom_objective_time as: 
    temp_benchmark_m2zpzw2k/minimal_benchmark/outputs/custom_objective_time.pdf
