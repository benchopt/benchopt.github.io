...
.. raw:: html
    ...
    <input  id='example-benchmark-5103b41b34ab4a8cb15f747c6b863867-1' name='example-benchmark-5103b41b34ab4a8cb15f747c6b863867' type='radio'><label for='example-benchmark-5103b41b34ab4a8cb15f747c6b863867-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-5103b41b34ab4a8cb15f747c6b863867-2' name='example-benchmark-5103b41b34ab4a8cb15f747c6b863867' type='radio'><label for='example-benchmark-5103b41b34ab4a8cb15f747c6b863867-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
...
.. raw:: html
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_2gqlgnpk/minimal_benchmark/outputs/benchopt_run_2026-06-04_10h0</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">2m17.parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_2gqlgnpk/minimal_benchmark/outputs/benchopt_run_2026-06-04_10h0
    2m17.parquet
    done
    Writing results to 
    temp_benchmark_2gqlgnpk/minimal_benchmark/outputs/minimal_benchmark_benchopt_r
    un_2026-06-04_10h02m17.html
    Writing minimal_benchmark index to 
    temp_benchmark_2gqlgnpk/minimal_benchmark/outputs/minimal_benchmark.html
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='minimal_benchmark.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-4d984975dd424fb18a096bdd1c63775f-0' name='example-benchmark-4d984975dd424fb18a096bdd1c63775f' type='radio'><label for='example-benchmark-4d984975dd424fb18a096bdd1c63775f-0'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="nt">plot_configs</span><span class="p">:</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>plot<span class="w"> </span>temp_benchmark_2gqlgnpk/minimal_benchmark
    </pre></div>
    </pre>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    <p>We now update the following files:</p><br/>
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='minimal_benchmark.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-0e1c826be00f4e6d8b1f96f1d2784b4b-0' name='example-benchmark-0e1c826be00f4e6d8b1f96f1d2784b4b' type='radio'><label for='example-benchmark-0e1c826be00f4e6d8b1f96f1d2784b4b-0'>plots/custom_objective_time.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BasePlot</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    <p>We now update the following files:</p><br/>
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='minimal_benchmark.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-2561341f778a4d08a585424cc8e8a383-0' name='example-benchmark-2561341f778a4d08a585424cc8e8a383' type='radio'><label for='example-benchmark-2561341f778a4d08a585424cc8e8a383-0'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="nt">plot_configs</span><span class="p">:</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>plot<span class="w"> </span>temp_benchmark_2gqlgnpk/minimal_benchmark<span class="w"> </span>-k<span class="w"> </span>custom_objective_time<span class="w"> </span>--no-html
    </pre></div>
    </pre>
            
                <div class="sphx-glr-script-out highlight-none notranslate">
                    <div class="highlight"><pre>Save custom_objective_time as: 
    temp_benchmark_2gqlgnpk/minimal_benchmark/outputs/custom_objective_time.pdf
