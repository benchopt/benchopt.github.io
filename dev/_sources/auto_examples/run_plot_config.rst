...
.. raw:: html
    ...
    <input  id='example-benchmark-11ae7475b7cc4b4097da525713e44093-1' name='example-benchmark-11ae7475b7cc4b4097da525713e44093' type='radio'><label for='example-benchmark-11ae7475b7cc4b4097da525713e44093-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-11ae7475b7cc4b4097da525713e44093-2' name='example-benchmark-11ae7475b7cc4b4097da525713e44093' type='radio'><label for='example-benchmark-11ae7475b7cc4b4097da525713e44093-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_60zfhuz_/minimal_benchmark<span class="w"> </span>-n<span class="w"> </span><span class="m">40</span><span class="w"> </span>-r<span class="w"> </span><span class="m">2</span><span class="w"> </span>-s<span class="w"> </span>gd<span class="o">[</span><span class="nv">lr</span><span class="o">=[</span>1e-1,3e-2,1e-2,3e-3<span class="o">]]</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_60zfhuz_/minimal_benchmark/outputs/benchopt_run_2026-07-18_08h0</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">4m27.parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_60zfhuz_/minimal_benchmark/outputs/benchopt_run_2026-07-18_08h0
    4m27.parquet
    done
    Writing results to 
    temp_benchmark_60zfhuz_/minimal_benchmark/outputs/minimal_benchmark_benchopt_r
    un_2026-07-18_08h04m27.html
    Writing minimal_benchmark index to 
    temp_benchmark_60zfhuz_/minimal_benchmark/outputs/minimal_benchmark.html
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='minimal_benchmark.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-2039db74f9824c158b9f967325dbb124-0' name='example-benchmark-2039db74f9824c158b9f967325dbb124' type='radio'><label for='example-benchmark-2039db74f9824c158b9f967325dbb124-0'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="nt">plot_configs</span><span class="p">:</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>plot<span class="w"> </span>temp_benchmark_60zfhuz_/minimal_benchmark
    </pre></div>
    </pre>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    <p>We now update the following files:</p><br/>
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='minimal_benchmark.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-bdf11a01a8ce4e71806267594b511a97-0' name='example-benchmark-bdf11a01a8ce4e71806267594b511a97' type='radio'><label for='example-benchmark-bdf11a01a8ce4e71806267594b511a97-0'>plots/custom_objective_time.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BasePlot</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    <p>We now update the following files:</p><br/>
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='minimal_benchmark.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-d755de1601ec43e2961871cf63368ed7-0' name='example-benchmark-d755de1601ec43e2961871cf63368ed7' type='radio'><label for='example-benchmark-d755de1601ec43e2961871cf63368ed7-0'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="nt">plot_configs</span><span class="p">:</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>plot<span class="w"> </span>temp_benchmark_60zfhuz_/minimal_benchmark<span class="w"> </span>-k<span class="w"> </span>custom_objective_time<span class="w"> </span>--no-html
    </pre></div>
    </pre>
            
                <div class="sphx-glr-script-out highlight-none notranslate">
                    <div class="highlight"><pre>Save custom_objective_time as: 
    temp_benchmark_60zfhuz_/minimal_benchmark/outputs/custom_objective_time.pdf
