...
.. raw:: html
    ...
    <input  id='example-benchmark-6a1f285bcbb64453a0448f5a9692a6c0-1' name='example-benchmark-6a1f285bcbb64453a0448f5a9692a6c0' type='radio'><label for='example-benchmark-6a1f285bcbb64453a0448f5a9692a6c0-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-6a1f285bcbb64453a0448f5a9692a6c0-2' name='example-benchmark-6a1f285bcbb64453a0448f5a9692a6c0' type='radio'><label for='example-benchmark-6a1f285bcbb64453a0448f5a9692a6c0-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
...
.. raw:: html
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_teqa4g40/minimal_benchmark/outputs/benchopt_run_2026-07-23_04h5</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">4m17.parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_teqa4g40/minimal_benchmark/outputs/benchopt_run_2026-07-23_04h5
    4m17.parquet
    done
    Writing results to 
    temp_benchmark_teqa4g40/minimal_benchmark/outputs/minimal_benchmark_benchopt_r
    un_2026-07-23_04h54m17.html
    Writing minimal_benchmark index to 
    temp_benchmark_teqa4g40/minimal_benchmark/outputs/minimal_benchmark.html
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='minimal_benchmark.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-863d54d26e4a4c48bde28621bdfbf040-0' name='example-benchmark-863d54d26e4a4c48bde28621bdfbf040' type='radio'><label for='example-benchmark-863d54d26e4a4c48bde28621bdfbf040-0'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="nt">plot_configs</span><span class="p">:</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>plot<span class="w"> </span>temp_benchmark_teqa4g40/minimal_benchmark
    </pre></div>
    </pre>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    <p>We now update the following files:</p><br/>
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='minimal_benchmark.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-bca7bf0fe1ff44709db3cefb3b613401-0' name='example-benchmark-bca7bf0fe1ff44709db3cefb3b613401' type='radio'><label for='example-benchmark-bca7bf0fe1ff44709db3cefb3b613401-0'>plots/custom_objective_time.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BasePlot</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    <p>We now update the following files:</p><br/>
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='minimal_benchmark.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-78f08562824845e1b6f3bdaa7bc02621-0' name='example-benchmark-78f08562824845e1b6f3bdaa7bc02621' type='radio'><label for='example-benchmark-78f08562824845e1b6f3bdaa7bc02621-0'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="nt">plot_configs</span><span class="p">:</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>plot<span class="w"> </span>temp_benchmark_teqa4g40/minimal_benchmark<span class="w"> </span>-k<span class="w"> </span>custom_objective_time<span class="w"> </span>--no-html
    </pre></div>
    </pre>
            
                <div class="sphx-glr-script-out highlight-none notranslate">
                    <div class="highlight"><pre>Save custom_objective_time as: 
    temp_benchmark_teqa4g40/minimal_benchmark/outputs/custom_objective_time.pdf
