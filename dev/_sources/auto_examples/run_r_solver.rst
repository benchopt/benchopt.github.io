...
.. raw:: html
    ...
    <input  id='example-benchmark-dab6e1ac680748c9907591f4cdd5fb68-1' name='example-benchmark-dab6e1ac680748c9907591f4cdd5fb68' type='radio'><label for='example-benchmark-dab6e1ac680748c9907591f4cdd5fb68-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-dab6e1ac680748c9907591f4cdd5fb68-2' name='example-benchmark-dab6e1ac680748c9907591f4cdd5fb68' type='radio'><label for='example-benchmark-dab6e1ac680748c9907591f4cdd5fb68-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-dab6e1ac680748c9907591f4cdd5fb68-3' name='example-benchmark-dab6e1ac680748c9907591f4cdd5fb68' type='radio'><label for='example-benchmark-dab6e1ac680748c9907591f4cdd5fb68-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='r_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-1d19cfa7e7e44f019c7ecfa0b05d35f3-0' name='example-benchmark-1d19cfa7e7e44f019c7ecfa0b05d35f3' type='radio'><label for='example-benchmark-1d19cfa7e7e44f019c7ecfa0b05d35f3-0'>solvers/r_pgd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-1d19cfa7e7e44f019c7ecfa0b05d35f3-1' name='example-benchmark-1d19cfa7e7e44f019c7ecfa0b05d35f3' type='radio'><label for='example-benchmark-1d19cfa7e7e44f019c7ecfa0b05d35f3-1'>solvers/r_pgd.R</label><div class='sd-tab-content'><div class="highlight"><pre><span></span>##&#39; Functions used in GD algorithm
    ##&#39;
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_i4oslnpw/r_solver<span class="w"> </span>-s<span class="w"> </span>r-pgd
    </pre></div>
    </pre>
    ...
    gcc_impl_linux-64-15 | 77.4 MB   |            |   1% [A
    sysroot_linux-64-2.3 | 40.1 MB   | 1          |   2% 

    r-base-4.5.3         | 26.1 MB   |            |   1% 


    libstdcxx-devel_linu | 19.8 MB   | 2          |   2% 



    gcc_impl_linux-64-15 | 77.4 MB   | 2          |   3% 
    sysroot_linux-64-2.3 | 40.1 MB   | 6          |   6% 

    r-base-4.5.3         | 26.1 MB   | 7          |   7% 


    libstdcxx-devel_linu | 19.8 MB   | #2         |  12% 



    gcc_impl_linux-64-15 | 77.4 MB   | 4          |   5% 
    sysroot_linux-64-2.3 | 40.1 MB   | #          |  11% 

    r-base-4.5.3         | 26.1 MB   | #2         |  13% 


    libstdcxx-devel_linu | 19.8 MB   | ##         |  20% 



    gfortran_impl_linux- | 19.1 MB   | ##         |  21% 
    gcc_impl_linux-64-15 | 77.4 MB   | 7          |   8% 

    r-base-4.5.3         | 26.1 MB   | ##1        |  21% 


    libstdcxx-devel_linu | 19.8 MB   | ###2       |  32% 



    gcc_impl_linux-64-15 | 77.4 MB   | 9          |  10% 
    sysroot_linux-64-2.3 | 40.1 MB   | ##1        |  21% 


    libstdcxx-devel_linu | 19.8 MB   | ####1      |  42% 
    ...
    r-base-4.5.3         | 26.1 MB   | ###5       |  35% 


    libstdcxx-devel_linu | 19.8 MB   | #####1     |  51% 



    gcc_impl_linux-64-15 | 77.4 MB   | #4         |  14% 
    sysroot_linux-64-2.3 | 40.1 MB   | ###        |  31% 

    r-base-4.5.3         | 26.1 MB   | ####1      |  42% 


    libstdcxx-devel_linu | 19.8 MB   | ######     |  61% 



    gcc_impl_linux-64-15 | 77.4 MB   | #6         |  17% 
    sysroot_linux-64-2.3 | 40.1 MB   | ###5       |  36% 

    r-base-4.5.3         | 26.1 MB   | ####9      |  49% 


    libstdcxx-devel_linu | 19.8 MB   | #######1   |  71% 
    ...
    libstdcxx-devel_linu | 19.8 MB   | ########1  |  82% 



    gcc_impl_linux-64-15 | 77.4 MB   | ##2        |  23% 
    sysroot_linux-64-2.3 | 40.1 MB   | ####6      |  47% 

    r-base-4.5.3         | 26.1 MB   | ######6    |  67% 


    libstdcxx-devel_linu | 19.8 MB   | #########4 |  94% 



    gcc_impl_linux-64-15 | 77.4 MB   | ##5        |  25% 
    sysroot_linux-64-2.3 | 40.1 MB   | #####2     |  52% 

    gcc_impl_linux-64-15 | 77.4 MB   | ###        |  31% 
    sysroot_linux-64-2.3 | 40.1 MB   | ######1    |  61% 

    gcc_impl_linux-64-15 | 77.4 MB   | ###4       |  35% 
    gcc_impl_linux-64-15 | 77.4 MB   | ####1      |  42% 
    gcc_impl_linux-64-15 | 77.4 MB   | ####7      |  48% 
    sysroot_linux-64-2.3 | 40.1 MB   | #########4 |  95% 
    ...
    gxx_impl_linux-64-15 | 15.6 MB   | 8          |   9% 
    ...
    gxx_impl_linux-64-15 | 15.6 MB   | #8         |  19% 





    libsanitizer-15.2.0  | 7.6 MB    | ###6       |  36% 




    gxx_impl_linux-64-15 | 15.6 MB   | ##9        |  29% 





    gcc_impl_linux-64-15 | 77.4 MB   | #####7     |  58% 




    gxx_impl_linux-64-15 | 15.6 MB   | ###7       |  38% 





    libsanitizer-15.2.0  | 7.6 MB    | #######4   |  75% 




    gxx_impl_linux-64-15 | 15.6 MB   | ####5      |  46% 





    libsanitizer-15.2.0  | 7.6 MB    | #########1 |  92% 




    gcc_impl_linux-64-15 | 77.4 MB   | ######1    |  61% 




    gcc_impl_linux-64-15 | 77.4 MB   | ######5    |  65% 
    ...
    gxx_impl_linux-64-15 | 15.6 MB   | ########1  |  82% 
    ...
    gxx_impl_linux-64-15 | 15.6 MB   | #########1 |  91% 
    ...
    libopenblas-0.3.33   | 5.7 MB    | ###7       |  38% 
    ...
    libopenblas-0.3.33   | 5.7 MB    | ######2    |  63% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | #######3   |  73% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | ########   |  81% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | ########2  |  83% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | ########5  |  86% 




    gcc_impl_linux-64-15 | 77.4 MB   | #########  |  91% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | #########3 |  94% 
    ...
    libgcc-devel_linux-6 | 3.0 MB    | #######8   |  78% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | #########7 |  97% 
    ...
    temp_benchmark_i4oslnpw/r_solver/solvers/r_pgd.py. Please fix the following 
    ...
    _get_module_from_file
      ...
      File 
    &quot;/home/circleci/project/examples/temp_benchmark_i4oslnpw/r_solver/solvers/r_pg
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_i4oslnpw/r_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_i4oslnpw/r_solver/outputs/benchopt_run_2026-07-09_04h02m17.parq</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">uet</span> 
    Rendering benchmark results...
       Processing 
    temp_benchmark_i4oslnpw/r_solver/outputs/benchopt_run_2026-07-09_04h02m17.parq
    uet
    done
    Writing results to 
    temp_benchmark_i4oslnpw/r_solver/outputs/r_solver_benchopt_run_2026-07-09_04h0
    2m17.html
    Writing r_solver index to 
    temp_benchmark_i4oslnpw/r_solver/outputs/r_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (2 minutes 54.494 seconds)
