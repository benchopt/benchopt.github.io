...
.. raw:: html
    ...
    <input  id='example-benchmark-d14b1f23383a492fbb7a0caea5fb72b4-1' name='example-benchmark-d14b1f23383a492fbb7a0caea5fb72b4' type='radio'><label for='example-benchmark-d14b1f23383a492fbb7a0caea5fb72b4-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-d14b1f23383a492fbb7a0caea5fb72b4-2' name='example-benchmark-d14b1f23383a492fbb7a0caea5fb72b4' type='radio'><label for='example-benchmark-d14b1f23383a492fbb7a0caea5fb72b4-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-d14b1f23383a492fbb7a0caea5fb72b4-3' name='example-benchmark-d14b1f23383a492fbb7a0caea5fb72b4' type='radio'><label for='example-benchmark-d14b1f23383a492fbb7a0caea5fb72b4-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='r_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-6e5af202ec33430db7fb67134ca1843a-0' name='example-benchmark-6e5af202ec33430db7fb67134ca1843a' type='radio'><label for='example-benchmark-6e5af202ec33430db7fb67134ca1843a-0'>solvers/r_pgd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-6e5af202ec33430db7fb67134ca1843a-1' name='example-benchmark-6e5af202ec33430db7fb67134ca1843a' type='radio'><label for='example-benchmark-6e5af202ec33430db7fb67134ca1843a-1'>solvers/r_pgd.R</label><div class='sd-tab-content'><div class="highlight"><pre><span></span>##' Functions used in GD algorithm
    ##'
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_ul1det3c/r_solver<span class="w"> </span>-s<span class="w"> </span>r-pgd
    </pre></div>
    </pre>
    ...
    gcc_impl_linux-64-16 | 82.5 MB   | 8          |   8% [A
    sysroot_linux-64-2.3 | 40.1 MB   | #6         |  17% 

    r-base-4.5.3         | 26.1 MB   | ##8        |  29% 


    libstdcxx-devel_linu | 21.4 MB   | #5         |  16% 
    ...
    libstdcxx-devel_linu | 21.4 MB   | #####8     |  58% 



    gcc_impl_linux-64-16 | 82.5 MB   | ###1       |  31% 
    gcc_impl_linux-64-16 | 82.5 MB   | ####7      |  47% 
    ...
    gcc_impl_linux-64-16 | 82.5 MB   | ######5    |  65% 
    ...
    gxx_impl_linux-64-16 | 16.9 MB   | ####9      |  50% 
    ...
    gxx_impl_linux-64-16 | 16.9 MB   | ########9  |  90% 
    ...
    gcc_impl_linux-64-16 | 82.5 MB   | #########2 |  92% 
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_ul1det3c/r_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_ul1det3c/r_solver/outputs/benchopt_run_2026-09-01_12h19m05.parq</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">uet</span> 
    Rendering benchmark results...
       Processing 
    temp_benchmark_ul1det3c/r_solver/outputs/benchopt_run_2026-09-01_12h19m05.parq
    uet
    done
    Writing results to 
    temp_benchmark_ul1det3c/r_solver/outputs/r_solver_benchopt_run_2026-09-01_12h1
    9m05.html
    Writing r_solver index to 
    temp_benchmark_ul1det3c/r_solver/outputs/r_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (2 minutes 42.216 seconds)
