...
.. raw:: html
    ...
    <input  id='example-benchmark-9f2682853e4e490587b45a58d0f48cbb-1' name='example-benchmark-9f2682853e4e490587b45a58d0f48cbb' type='radio'><label for='example-benchmark-9f2682853e4e490587b45a58d0f48cbb-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-9f2682853e4e490587b45a58d0f48cbb-2' name='example-benchmark-9f2682853e4e490587b45a58d0f48cbb' type='radio'><label for='example-benchmark-9f2682853e4e490587b45a58d0f48cbb-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-9f2682853e4e490587b45a58d0f48cbb-3' name='example-benchmark-9f2682853e4e490587b45a58d0f48cbb' type='radio'><label for='example-benchmark-9f2682853e4e490587b45a58d0f48cbb-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='r_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-da61445edfa1408193934ac3fb303409-0' name='example-benchmark-da61445edfa1408193934ac3fb303409' type='radio'><label for='example-benchmark-da61445edfa1408193934ac3fb303409-0'>solvers/r_pgd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-da61445edfa1408193934ac3fb303409-1' name='example-benchmark-da61445edfa1408193934ac3fb303409' type='radio'><label for='example-benchmark-da61445edfa1408193934ac3fb303409-1'>solvers/r_pgd.R</label><div class='sd-tab-content'><div class="highlight"><pre><span></span>##&#39; Functions used in GD algorithm
    ##&#39;
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_t4tuj7n0/r_solver<span class="w"> </span>-s<span class="w"> </span>r-pgd
    </pre></div>
    </pre>
    ...
    libstdcxx-devel_linu | 19.8 MB   |            |   1% 



    gcc_impl_linux-64-15 | 77.4 MB   | 4          |   5% 
    sysroot_linux-64-2.3 | 40.1 MB   | 7          |   8% 

    r-base-4.5.3         | 26.1 MB   | #5         |  16% 


    libstdcxx-devel_linu | 19.8 MB   | #2         |  13% 



    gcc_impl_linux-64-15 | 77.4 MB   | 8          |   9% 
    sysroot_linux-64-2.3 | 40.1 MB   | #4         |  15% 

    r-base-4.5.3         | 26.1 MB   | ##6        |  26% 
    ...
    libstdcxx-devel_linu | 19.8 MB   | ####2      |  42% 
    ...
    sysroot_linux-64-2.3 | 40.1 MB   | ##8        |  28% 


    libstdcxx-devel_linu | 19.8 MB   | #####4     |  55% 



    gfortran_impl_linux- | 19.1 MB   | #####5     |  55% 
    gcc_impl_linux-64-15 | 77.4 MB   | #8         |  19% 

    r-base-4.5.3         | 26.1 MB   | #####7     |  57% 



    gfortran_impl_linux- | 19.1 MB   | ######7    |  68% 


    libstdcxx-devel_linu | 19.8 MB   | ######7    |  67% 
    gcc_impl_linux-64-15 | 77.4 MB   | ##1        |  22% 

    r-base-4.5.3         | 26.1 MB   | ######6    |  67% 


    libstdcxx-devel_linu | 19.8 MB   | #######8   |  79% 



    gfortran_impl_linux- | 19.1 MB   | #######9   |  80% 
    gcc_impl_linux-64-15 | 77.4 MB   | ##5        |  25% 

    r-base-4.5.3         | 26.1 MB   | #######6   |  76% 


    libstdcxx-devel_linu | 19.8 MB   | #########2 |  92% 



    gfortran_impl_linux- | 19.1 MB   | #########1 |  92% 
    gcc_impl_linux-64-15 | 77.4 MB   | ##8        |  28% 

    r-base-4.5.3         | 26.1 MB   | ########6  |  86% 
    gcc_impl_linux-64-15 | 77.4 MB   | ###2       |  32% 

    r-base-4.5.3         | 26.1 MB   | #########9 | 100% 
    gcc_impl_linux-64-15 | 77.4 MB   | ###7       |  38% 
    gcc_impl_linux-64-15 | 77.4 MB   | ####4      |  44% 
    gcc_impl_linux-64-15 | 77.4 MB   | #####      |  50% 
    ...
    gxx_impl_linux-64-15 | 15.6 MB   | #          |  10% 
    ...
    gxx_impl_linux-64-15 | 15.6 MB   | ##3        |  24% 
    ...
    libsanitizer-15.2.0  | 7.6 MB    | #######8   |  78% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | ######7    |  68% 
    ...
    libopenblas-0.3.33   | 5.7 MB    | ###2       |  33% 
    ...
    libopenblas-0.3.33   | 5.7 MB    | ######4    |  65% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | #######7   |  77% 
    ...
    binutils_impl_linux- | 3.5 MB    | #####4     |  55% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | ########6  |  86% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | ########9  |  89% 
    ...
    libgfortran5-15.2.0  | 2.4 MB    | ########1  |  81% 
    ...
    temp_benchmark_t4tuj7n0/r_solver/solvers/r_pgd.py. Please fix the following 
    ...
    _get_module_from_file
      ...
      File 
    &quot;/home/circleci/project/examples/temp_benchmark_t4tuj7n0/r_solver/solvers/r_pg
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_t4tuj7n0/r_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_t4tuj7n0/r_solver/outputs/benchopt_run_2026-05-21_14h39m43.parq</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">uet</span> 
    Rendering benchmark results...
       Processing 
    temp_benchmark_t4tuj7n0/r_solver/outputs/benchopt_run_2026-05-21_14h39m43.parq
    uet
    done
    Writing results to 
    temp_benchmark_t4tuj7n0/r_solver/outputs/r_solver_benchopt_run_2026-05-21_14h3
    9m43.html
    Writing r_solver index to 
    temp_benchmark_t4tuj7n0/r_solver/outputs/r_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (2 minutes 41.875 seconds)
