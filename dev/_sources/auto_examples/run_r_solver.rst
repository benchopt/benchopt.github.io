...
.. raw:: html
    ...
    <input  id='example-benchmark-c20bf50b9e9246f4a7b27ef9d83f16eb-1' name='example-benchmark-c20bf50b9e9246f4a7b27ef9d83f16eb' type='radio'><label for='example-benchmark-c20bf50b9e9246f4a7b27ef9d83f16eb-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-c20bf50b9e9246f4a7b27ef9d83f16eb-2' name='example-benchmark-c20bf50b9e9246f4a7b27ef9d83f16eb' type='radio'><label for='example-benchmark-c20bf50b9e9246f4a7b27ef9d83f16eb-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-c20bf50b9e9246f4a7b27ef9d83f16eb-3' name='example-benchmark-c20bf50b9e9246f4a7b27ef9d83f16eb' type='radio'><label for='example-benchmark-c20bf50b9e9246f4a7b27ef9d83f16eb-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='r_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-eebaa17041db47128b936f573224198c-0' name='example-benchmark-eebaa17041db47128b936f573224198c' type='radio'><label for='example-benchmark-eebaa17041db47128b936f573224198c-0'>solvers/r_pgd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-eebaa17041db47128b936f573224198c-1' name='example-benchmark-eebaa17041db47128b936f573224198c' type='radio'><label for='example-benchmark-eebaa17041db47128b936f573224198c-1'>solvers/r_pgd.R</label><div class='sd-tab-content'><div class="highlight"><pre><span></span>##' Functions used in GD algorithm
    ##'
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_sr21fjlk/r_solver<span class="w"> </span>-s<span class="w"> </span>r-pgd
    </pre></div>
    </pre>
    ...
    gcc_impl_linux-64-16 | 82.5 MB   | 9          |  10% [A
    sysroot_linux-64-2.3 | 40.1 MB   | #          |  10% 

    r-base-4.5.3         | 26.1 MB   | ##3        |  23% 


    libstdcxx-devel_linu | 21.4 MB   | 8          |   9% 



    gcc_impl_linux-64-16 | 82.5 MB   | ##2        |  22% 
    ...
    gfortran_impl_linux- | 20.2 MB   | ########4  |  85% 


    gcc_impl_linux-64-16 | 82.5 MB   | ###8       |  39% 
    sysroot_linux-64-2.3 | 40.1 MB   | #######2   |  72% 


    libstdcxx-devel_linu | 21.4 MB   | ########4  |  85% 
    ...
    gcc_impl_linux-64-16 | 82.5 MB   | ######8    |  69% 
    ...
    libsanitizer-16.2.0  | 7.8 MB    | #########3 |  93% 
    ...
    gcc_impl_linux-64-16 | 82.5 MB   | #########4 |  95% 
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_sr21fjlk/r_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_sr21fjlk/r_solver/outputs/benchopt_run_2026-08-31_12h21m49.parq</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">uet</span> 
    Rendering benchmark results...
       Processing 
    temp_benchmark_sr21fjlk/r_solver/outputs/benchopt_run_2026-08-31_12h21m49.parq
    uet
    done
    Writing results to 
    temp_benchmark_sr21fjlk/r_solver/outputs/r_solver_benchopt_run_2026-08-31_12h2
    1m49.html
    Writing r_solver index to 
    temp_benchmark_sr21fjlk/r_solver/outputs/r_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (2 minutes 46.001 seconds)
