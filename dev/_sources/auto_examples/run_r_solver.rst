...
.. raw:: html
    ...
    <input  id='example-benchmark-7a11f41c957f4f7ea59c0bd1032c84a6-1' name='example-benchmark-7a11f41c957f4f7ea59c0bd1032c84a6' type='radio'><label for='example-benchmark-7a11f41c957f4f7ea59c0bd1032c84a6-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-7a11f41c957f4f7ea59c0bd1032c84a6-2' name='example-benchmark-7a11f41c957f4f7ea59c0bd1032c84a6' type='radio'><label for='example-benchmark-7a11f41c957f4f7ea59c0bd1032c84a6-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-7a11f41c957f4f7ea59c0bd1032c84a6-3' name='example-benchmark-7a11f41c957f4f7ea59c0bd1032c84a6' type='radio'><label for='example-benchmark-7a11f41c957f4f7ea59c0bd1032c84a6-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='r_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-3a6370dc0a6c4261a15b2af4c910cc92-0' name='example-benchmark-3a6370dc0a6c4261a15b2af4c910cc92' type='radio'><label for='example-benchmark-3a6370dc0a6c4261a15b2af4c910cc92-0'>solvers/r_pgd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-3a6370dc0a6c4261a15b2af4c910cc92-1' name='example-benchmark-3a6370dc0a6c4261a15b2af4c910cc92' type='radio'><label for='example-benchmark-3a6370dc0a6c4261a15b2af4c910cc92-1'>solvers/r_pgd.R</label><div class='sd-tab-content'><div class="highlight"><pre><span></span>##' Functions used in GD algorithm
    ##'
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_yidem0q2/r_solver<span class="w"> </span>-s<span class="w"> </span>r-pgd
    </pre></div>
    </pre>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_yidem0q2/r_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_yidem0q2/r_solver/outputs/benchopt_run_2026-09-21_15h14m47.parq</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">uet</span> 
    Rendering benchmark results...
       Processing 
    temp_benchmark_yidem0q2/r_solver/outputs/benchopt_run_2026-09-21_15h14m47.parq
    uet
    done
    Writing results to 
    temp_benchmark_yidem0q2/r_solver/outputs/r_solver_benchopt_run_2026-09-21_15h1
    4m47.html
    Writing r_solver index to 
    temp_benchmark_yidem0q2/r_solver/outputs/r_solver.html
