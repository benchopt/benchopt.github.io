...
.. raw:: html
    ...
    <input  id='example-benchmark-a528266411694f8d85c3f8a9e4c32617-1' name='example-benchmark-a528266411694f8d85c3f8a9e4c32617' type='radio'><label for='example-benchmark-a528266411694f8d85c3f8a9e4c32617-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-a528266411694f8d85c3f8a9e4c32617-2' name='example-benchmark-a528266411694f8d85c3f8a9e4c32617' type='radio'><label for='example-benchmark-a528266411694f8d85c3f8a9e4c32617-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-a528266411694f8d85c3f8a9e4c32617-3' name='example-benchmark-a528266411694f8d85c3f8a9e4c32617' type='radio'><label for='example-benchmark-a528266411694f8d85c3f8a9e4c32617-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='r_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-2d1297e2580e4fada902021620d03a8f-0' name='example-benchmark-2d1297e2580e4fada902021620d03a8f' type='radio'><label for='example-benchmark-2d1297e2580e4fada902021620d03a8f-0'>solvers/r_pgd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-2d1297e2580e4fada902021620d03a8f-1' name='example-benchmark-2d1297e2580e4fada902021620d03a8f' type='radio'><label for='example-benchmark-2d1297e2580e4fada902021620d03a8f-1'>solvers/r_pgd.R</label><div class='sd-tab-content'><div class="highlight"><pre><span></span>##&#39; Functions used in GD algorithm
    ##&#39;
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_aq50ygv6/r_solver<span class="w"> </span>-s<span class="w"> </span>r-pgd
    </pre></div>
    </pre>
    ...
    r-base-4.5.3         | 26.1 MB   | 8          |   8% 


    libstdcxx-devel_linu | 21.5 MB   | #          |  11% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | #4         |  15% 
    sysroot_linux-64-2.3 | 40.1 MB   | ##9        |  29% 

    r-base-4.5.3         | 26.1 MB   | ####4      |  45% 


    libstdcxx-devel_linu | 21.5 MB   | #####2     |  53% 



    gcc_impl_linux-64-16 | 81.2 MB   | ##         |  20% 



    gfortran_impl_linux- | 20.1 MB   | #######7   |  78% 

    r-base-4.5.3         | 26.1 MB   | ######     |  61% 
    sysroot_linux-64-2.3 | 40.1 MB   | ###9       |  39% 


    gcc_impl_linux-64-16 | 81.2 MB   | ##5        |  25% 
    sysroot_linux-64-2.3 | 40.1 MB   | ####9      |  49% 


    libstdcxx-devel_linu | 21.5 MB   | ########9  |  90% 

    r-base-4.5.3         | 26.1 MB   | #######6   |  76% 



    gcc_impl_linux-64-16 | 81.2 MB   | ###1       |  31% 
    sysroot_linux-64-2.3 | 40.1 MB   | ######1    |  61% 

    gcc_impl_linux-64-16 | 81.2 MB   | ###9       |  40% 
    gcc_impl_linux-64-16 | 81.2 MB   | ####8      |  49% 
    ...
    libsanitizer-16.1.0  | 7.4 MB    | #####3     |  54% 
    ...
    gxx_impl_linux-64-16 | 15.9 MB   | #######7   |  78% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | #######    |  71% 




    gxx_impl_linux-64-16 | 15.9 MB   | #########9 | 100% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | #######7   |  77% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | ########3  |  83% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | #########9 | 100% 
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_aq50ygv6/r_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_aq50ygv6/r_solver/outputs/benchopt_run_2026-08-01_13h56m42.parq</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">uet</span> 
    Rendering benchmark results...
       Processing 
    temp_benchmark_aq50ygv6/r_solver/outputs/benchopt_run_2026-08-01_13h56m42.parq
    uet
    done
    Writing results to 
    temp_benchmark_aq50ygv6/r_solver/outputs/r_solver_benchopt_run_2026-08-01_13h5
    6m42.html
    Writing r_solver index to 
    temp_benchmark_aq50ygv6/r_solver/outputs/r_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 59.024 seconds)
