...
.. raw:: html
    ...
    <input  id='example-benchmark-30e0ced6f9814b0da048c2a4a981ded9-1' name='example-benchmark-30e0ced6f9814b0da048c2a4a981ded9' type='radio'><label for='example-benchmark-30e0ced6f9814b0da048c2a4a981ded9-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-30e0ced6f9814b0da048c2a4a981ded9-2' name='example-benchmark-30e0ced6f9814b0da048c2a4a981ded9' type='radio'><label for='example-benchmark-30e0ced6f9814b0da048c2a4a981ded9-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-30e0ced6f9814b0da048c2a4a981ded9-3' name='example-benchmark-30e0ced6f9814b0da048c2a4a981ded9' type='radio'><label for='example-benchmark-30e0ced6f9814b0da048c2a4a981ded9-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='r_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-5c9e2444562d4a90aed590a257982c8a-0' name='example-benchmark-5c9e2444562d4a90aed590a257982c8a' type='radio'><label for='example-benchmark-5c9e2444562d4a90aed590a257982c8a-0'>solvers/r_pgd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-5c9e2444562d4a90aed590a257982c8a-1' name='example-benchmark-5c9e2444562d4a90aed590a257982c8a' type='radio'><label for='example-benchmark-5c9e2444562d4a90aed590a257982c8a-1'>solvers/r_pgd.R</label><div class='sd-tab-content'><div class="highlight"><pre><span></span>##' Functions used in GD algorithm
    ##'
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_vwhhomyn/r_solver<span class="w"> </span>-s<span class="w"> </span>r-pgd
    </pre></div>
    </pre>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_vwhhomyn/r_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_vwhhomyn/r_solver/outputs/benchopt_run_2026-09-20_21h59m30.parq</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">uet</span> 
    Rendering benchmark results...
       Processing 
    temp_benchmark_vwhhomyn/r_solver/outputs/benchopt_run_2026-09-20_21h59m30.parq
    uet
    done
    Writing results to 
    temp_benchmark_vwhhomyn/r_solver/outputs/r_solver_benchopt_run_2026-09-20_21h5
    9m30.html
    Writing r_solver index to 
    temp_benchmark_vwhhomyn/r_solver/outputs/r_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 31.528 seconds)
