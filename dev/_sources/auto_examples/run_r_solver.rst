...
.. raw:: html
    ...
    <input  id='example-benchmark-3a329e022f83475d80fd7b5e2ea07b92-1' name='example-benchmark-3a329e022f83475d80fd7b5e2ea07b92' type='radio'><label for='example-benchmark-3a329e022f83475d80fd7b5e2ea07b92-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-3a329e022f83475d80fd7b5e2ea07b92-2' name='example-benchmark-3a329e022f83475d80fd7b5e2ea07b92' type='radio'><label for='example-benchmark-3a329e022f83475d80fd7b5e2ea07b92-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-3a329e022f83475d80fd7b5e2ea07b92-3' name='example-benchmark-3a329e022f83475d80fd7b5e2ea07b92' type='radio'><label for='example-benchmark-3a329e022f83475d80fd7b5e2ea07b92-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='r_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-b563872d8fa74bbab62b725659c2dca9-0' name='example-benchmark-b563872d8fa74bbab62b725659c2dca9' type='radio'><label for='example-benchmark-b563872d8fa74bbab62b725659c2dca9-0'>solvers/r_pgd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-b563872d8fa74bbab62b725659c2dca9-1' name='example-benchmark-b563872d8fa74bbab62b725659c2dca9' type='radio'><label for='example-benchmark-b563872d8fa74bbab62b725659c2dca9-1'>solvers/r_pgd.R</label><div class='sd-tab-content'><div class="highlight"><pre><span></span>##&#39; Functions used in GD algorithm
    ##&#39;
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_wq0jhseg/r_solver<span class="w"> </span>-s<span class="w"> </span>r-pgd
    </pre></div>
    </pre>
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | 2          |   3% [A
    sysroot_linux-64-2.3 | 40.1 MB   | 6          |   6% 

    r-base-4.5.3         | 26.1 MB   | 4          |   4% 


    libstdcxx-devel_linu | 21.5 MB   | 6          |   7% 



    gcc_impl_linux-64-16 | 81.2 MB   | 7          |   8% 
    sysroot_linux-64-2.3 | 40.1 MB   | #6         |  17% 

    r-base-4.5.3         | 26.1 MB   | #7         |  18% 


    libstdcxx-devel_linu | 21.5 MB   | ##6        |  27% 



    gcc_impl_linux-64-16 | 81.2 MB   | #2         |  13% 
    sysroot_linux-64-2.3 | 40.1 MB   | ##6        |  26% 

    r-base-4.5.3         | 26.1 MB   | ###4       |  34% 


    libstdcxx-devel_linu | 21.5 MB   | ####6      |  47% 



    gcc_impl_linux-64-16 | 81.2 MB   | #7         |  18% 
    sysroot_linux-64-2.3 | 40.1 MB   | ###7       |  37% 

    r-base-4.5.3         | 26.1 MB   | #####      |  50% 


    libstdcxx-devel_linu | 21.5 MB   | ######6    |  67% 



    gcc_impl_linux-64-16 | 81.2 MB   | ##2        |  23% 
    sysroot_linux-64-2.3 | 40.1 MB   | ####7      |  47% 

    r-base-4.5.3         | 26.1 MB   | ######5    |  65% 


    libstdcxx-devel_linu | 21.5 MB   | ########5  |  85% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | ##7        |  28% 
    gcc_impl_linux-64-16 | 81.2 MB   | ###3       |  34% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | ###8       |  39% 
    ...
    gxx_impl_linux-64-16 | 15.9 MB   | ##2        |  22% 





    libsanitizer-16.1.0  | 7.4 MB    | #####5     |  56% 




    gxx_impl_linux-64-16 | 15.9 MB   | #####      |  51% 

    gcc_impl_linux-64-16 | 81.2 MB   | ####3      |  44% 
    ...
    gxx_impl_linux-64-16 | 15.9 MB   | #######2   |  73% 
    ...
    gxx_impl_linux-64-16 | 15.9 MB   | #########6 |  96% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | #####1     |  51% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | #####4     |  55% 
    ...
    binutils_impl_linux- | 3.5 MB    | #########8 |  99% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | #####7     |  58% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | ######2    |  62% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | ######7    |  67% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | #######1   |  71% 
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | #######5   |  75% [A
    ...
    gcc_impl_linux-64-16 | 81.2 MB   | ########9  |  89% [A



    gcc_impl_linux-64-16 | 81.2 MB   | #########7 |  98% 
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_wq0jhseg/r_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_wq0jhseg/r_solver/outputs/benchopt_run_2026-08-10_13h53m34.parq</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">uet</span> 
    Rendering benchmark results...
       Processing 
    temp_benchmark_wq0jhseg/r_solver/outputs/benchopt_run_2026-08-10_13h53m34.parq
    uet
    done
    Writing results to 
    temp_benchmark_wq0jhseg/r_solver/outputs/r_solver_benchopt_run_2026-08-10_13h5
    3m34.html
    Writing r_solver index to 
    temp_benchmark_wq0jhseg/r_solver/outputs/r_solver.html
