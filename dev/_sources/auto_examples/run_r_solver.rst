...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <input checked="checked" id='example-benchmark-632cea904b92468e9f39e6eb48b0a947-0' name='example-benchmark-632cea904b92468e9f39e6eb48b0a947' type='radio'><label for='example-benchmark-632cea904b92468e9f39e6eb48b0a947-0'>objective.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseObjective</span>
    ...
    <input  id='example-benchmark-632cea904b92468e9f39e6eb48b0a947-1' name='example-benchmark-632cea904b92468e9f39e6eb48b0a947' type='radio'><label for='example-benchmark-632cea904b92468e9f39e6eb48b0a947-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-632cea904b92468e9f39e6eb48b0a947-2' name='example-benchmark-632cea904b92468e9f39e6eb48b0a947' type='radio'><label for='example-benchmark-632cea904b92468e9f39e6eb48b0a947-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-632cea904b92468e9f39e6eb48b0a947-3' name='example-benchmark-632cea904b92468e9f39e6eb48b0a947' type='radio'><label for='example-benchmark-632cea904b92468e9f39e6eb48b0a947-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <input  id='example-benchmark-327f92663a47459895f7ac7bf7f80da8-1' name='example-benchmark-327f92663a47459895f7ac7bf7f80da8' type='radio'><label for='example-benchmark-327f92663a47459895f7ac7bf7f80da8-1'>solvers/r_pgd.R</label><div class='sd-tab-content'><div class="highlight"><pre><span></span>##&#39; Functions used in GD algorithm
    ##&#39;
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_0c7at87a/r_solver<span class="w"> </span>-s<span class="w"> </span>r-pgd
    </pre></div>
    </pre>
    ...
    gcc_impl_linux-64-15 | 78.0 MB   | 1          |   2% [A
    sysroot_linux-64-2.3 | 38.9 MB   |            |   1% 

    r-base-4.5.3         | 26.1 MB   | 2          |   2% 


    libstdcxx-devel_linu | 19.7 MB   | 3          |   3% 



    gcc_impl_linux-64-15 | 78.0 MB   | 5          |   6% 
    sysroot_linux-64-2.3 | 38.9 MB   | 8          |   8% 

    r-base-4.5.3         | 26.1 MB   | #2         |  13% 


    libstdcxx-devel_linu | 19.7 MB   | #6         |  17% 



    gcc_impl_linux-64-15 | 78.0 MB   | #          |  10% 
    sysroot_linux-64-2.3 | 38.9 MB   | #7         |  17% 

    r-base-4.5.3         | 26.1 MB   | ##4        |  25% 


    libstdcxx-devel_linu | 19.7 MB   | ###2       |  33% 



    gfortran_impl_linux- | 19.1 MB   | ####6      |  46% 
    gcc_impl_linux-64-15 | 78.0 MB   | #3         |  14% 

    r-base-4.5.3         | 26.1 MB   | ###4       |  35% 


    libstdcxx-devel_linu | 19.7 MB   | ####7      |  47% 



    gfortran_impl_linux- | 19.1 MB   | ######2    |  62% 

    gcc_impl_linux-64-15 | 78.0 MB   | #7         |  17% 


    libstdcxx-devel_linu | 19.7 MB   | ######     |  60% 
    sysroot_linux-64-2.3 | 38.9 MB   | ###3       |  33% 
    ...
    libstdcxx-devel_linu | 19.7 MB   | #######6   |  76% 
    sysroot_linux-64-2.3 | 38.9 MB   | ####1      |  41% 



    gcc_impl_linux-64-15 | 78.0 MB   | ##5        |  25% 
    sysroot_linux-64-2.3 | 38.9 MB   | ####8      |  49% 


    libstdcxx-devel_linu | 19.7 MB   | #########  |  90% 

    gcc_impl_linux-64-15 | 78.0 MB   | ###2       |  33% 
    sysroot_linux-64-2.3 | 38.9 MB   | ######3    |  64% 

    gcc_impl_linux-64-15 | 78.0 MB   | ###9       |  40% 
    gcc_impl_linux-64-15 | 78.0 MB   | ####7      |  47% 
    sysroot_linux-64-2.3 | 38.9 MB   | #########3 |  93% 
    ...
    gcc_impl_linux-64-15 | 78.0 MB   | #####3     |  53% 
    ...
    gxx_impl_linux-64-15 | 14.9 MB   | ##2        |  22% 





    gcc_impl_linux-64-15 | 78.0 MB   | #####9     |  60% 




    gxx_impl_linux-64-15 | 14.9 MB   | ####5      |  45% 





    libsanitizer-15.2.0  | 7.7 MB    | ########   |  80% 




    gcc_impl_linux-64-15 | 78.0 MB   | ######5    |  65% 




    gcc_impl_linux-64-15 | 78.0 MB   | #######    |  71% 
    ...
    gcc_impl_linux-64-15 | 78.0 MB   | #######5   |  76% 
    ...
    libopenblas-0.3.32   | 5.7 MB    | #####1     |  51% 
    ...
    gcc_impl_linux-64-15 | 78.0 MB   | ########5  |  85% 
    ...
    gcc_impl_linux-64-15 | 78.0 MB   | ########9  |  90% 
    ...
    binutils_impl_linux- | 3.5 MB    | #######3   |  73% 
    ...
    gcc_impl_linux-64-15 | 78.0 MB   | #########4 |  94% 
    ...
    temp_benchmark_0c7at87a/r_solver/solvers/r_pgd.py. Please fix the following 
    ...
    _get_module_from_file
      ...
      File 
    &quot;/home/circleci/project/examples/temp_benchmark_0c7at87a/r_solver/solvers/r_pg
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_0c7at87a/r_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_0c7at87a/r_solver/outputs/benchopt_run_2026-05-05_10h39m30.parq</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">uet</span> 
    Rendering benchmark results...
       Processing 
    temp_benchmark_0c7at87a/r_solver/outputs/benchopt_run_2026-05-05_10h39m30.parq
    uet
    done
    Writing results to 
    temp_benchmark_0c7at87a/r_solver/outputs/r_solver_benchopt_run_2026-05-05_10h3
    9m30.html
    Writing r_solver index to 
    temp_benchmark_0c7at87a/r_solver/outputs/r_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (3 minutes 35.596 seconds)
