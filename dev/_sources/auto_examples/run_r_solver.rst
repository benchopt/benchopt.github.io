...
.. raw:: html
    ...
    <input  id='example-benchmark-a63f5305f222410687449011d8e28b61-1' name='example-benchmark-a63f5305f222410687449011d8e28b61' type='radio'><label for='example-benchmark-a63f5305f222410687449011d8e28b61-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-a63f5305f222410687449011d8e28b61-2' name='example-benchmark-a63f5305f222410687449011d8e28b61' type='radio'><label for='example-benchmark-a63f5305f222410687449011d8e28b61-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-a63f5305f222410687449011d8e28b61-3' name='example-benchmark-a63f5305f222410687449011d8e28b61' type='radio'><label for='example-benchmark-a63f5305f222410687449011d8e28b61-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='r_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-2c92b124101c479ba0402cc828d9980d-0' name='example-benchmark-2c92b124101c479ba0402cc828d9980d' type='radio'><label for='example-benchmark-2c92b124101c479ba0402cc828d9980d-0'>solvers/r_pgd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-2c92b124101c479ba0402cc828d9980d-1' name='example-benchmark-2c92b124101c479ba0402cc828d9980d' type='radio'><label for='example-benchmark-2c92b124101c479ba0402cc828d9980d-1'>solvers/r_pgd.R</label><div class='sd-tab-content'><div class="highlight"><pre><span></span>##' Functions used in GD algorithm
    ##'
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_2fl1rdjh/r_solver<span class="w"> </span>-s<span class="w"> </span>r-pgd
    </pre></div>
    </pre>
    ...
    gcc_impl_linux-64-16 | 82.5 MB   | 1          |   2% [A
    sysroot_linux-64-2.3 | 40.1 MB   | 3          |   3% 

    r-base-4.5.3         | 26.1 MB   | 8          |   9% 


    libstdcxx-devel_linu | 21.4 MB   | 9          |   9% 



    gcc_impl_linux-64-16 | 82.5 MB   | 8          |   9% 
    sysroot_linux-64-2.3 | 40.1 MB   | #7         |  17% 

    r-base-4.5.3         | 26.1 MB   | ###        |  30% 


    libstdcxx-devel_linu | 21.4 MB   | ###5       |  35% 



    gcc_impl_linux-64-16 | 82.5 MB   | #5         |  15% 
    sysroot_linux-64-2.3 | 40.1 MB   | ###        |  31% 

    r-base-4.5.3         | 26.1 MB   | #####      |  51% 


    libstdcxx-devel_linu | 21.4 MB   | #####8     |  59% 



    gcc_impl_linux-64-16 | 82.5 MB   | ##2        |  23% 
    sysroot_linux-64-2.3 | 40.1 MB   | ####5      |  46% 

    r-base-4.5.3         | 26.1 MB   | #######3   |  74% 


    gcc_impl_linux-64-16 | 82.5 MB   | ###1       |  32% 
    gcc_impl_linux-64-16 | 82.5 MB   | ####3      |  44% 
    ...
    gcc_impl_linux-64-16 | 82.5 MB   | #####4     |  54% 
    ...
    gxx_impl_linux-64-16 | 16.9 MB   | ###7       |  38% 
    ...
    gxx_impl_linux-64-16 | 16.9 MB   | #######    |  71% 
    ...
    gcc_impl_linux-64-16 | 82.5 MB   | #######2   |  72% 
    ...
    libopenblas-0.3.34   | 5.7 MB    | ########8  |  88% 
    ...
    gcc_impl_linux-64-16 | 82.5 MB   | #######9   |  80% 
    ...
    gcc_impl_linux-64-16 | 82.5 MB   | ########7  |  87% 
    ...
    gcc_impl_linux-64-16 | 82.5 MB   | #########4 |  94% 
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_2fl1rdjh/r_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_2fl1rdjh/r_solver/outputs/benchopt_run_2026-09-01_12h19m50.parq</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">uet</span> 
    Rendering benchmark results...
       Processing 
    temp_benchmark_2fl1rdjh/r_solver/outputs/benchopt_run_2026-09-01_12h19m50.parq
    uet
    done
    Writing results to 
    temp_benchmark_2fl1rdjh/r_solver/outputs/r_solver_benchopt_run_2026-09-01_12h1
    9m50.html
    Writing r_solver index to 
    temp_benchmark_2fl1rdjh/r_solver/outputs/r_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (3 minutes 18.576 seconds)
