...
.. raw:: html
    ...
    <input  id='example-benchmark-4789455f7b164a7b8324af1e0b02f4da-1' name='example-benchmark-4789455f7b164a7b8324af1e0b02f4da' type='radio'><label for='example-benchmark-4789455f7b164a7b8324af1e0b02f4da-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-4789455f7b164a7b8324af1e0b02f4da-2' name='example-benchmark-4789455f7b164a7b8324af1e0b02f4da' type='radio'><label for='example-benchmark-4789455f7b164a7b8324af1e0b02f4da-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-4789455f7b164a7b8324af1e0b02f4da-3' name='example-benchmark-4789455f7b164a7b8324af1e0b02f4da' type='radio'><label for='example-benchmark-4789455f7b164a7b8324af1e0b02f4da-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='r_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-8a6a5f07488d48558af9907d20c61241-0' name='example-benchmark-8a6a5f07488d48558af9907d20c61241' type='radio'><label for='example-benchmark-8a6a5f07488d48558af9907d20c61241-0'>solvers/r_pgd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-8a6a5f07488d48558af9907d20c61241-1' name='example-benchmark-8a6a5f07488d48558af9907d20c61241' type='radio'><label for='example-benchmark-8a6a5f07488d48558af9907d20c61241-1'>solvers/r_pgd.R</label><div class='sd-tab-content'><div class="highlight"><pre><span></span>##&#39; Functions used in GD algorithm
    ##&#39;
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_bafg0_x6/r_solver<span class="w"> </span>-s<span class="w"> </span>r-pgd
    </pre></div>
    </pre>
    ...
    sysroot_linux-64-2.3 | 40.1 MB   | 1          |   1% 

    r-base-4.5.3         | 26.1 MB   | 3          |   3% 


    libstdcxx-devel_linu | 19.8 MB   | 3          |   3% 



    gfortran_impl_linux- | 19.1 MB   | 1          |   2% 
    sysroot_linux-64-2.3 | 40.1 MB   | 6          |   7% 

    r-base-4.5.3         | 26.1 MB   | #1         |  12% 


    libstdcxx-devel_linu | 19.8 MB   | #5         |  16% 



    gcc_impl_linux-64-15 | 77.4 MB   | 8          |   8% 
    sysroot_linux-64-2.3 | 40.1 MB   | #2         |  12% 

    r-base-4.5.3         | 26.1 MB   | ##         |  21% 


    libstdcxx-devel_linu | 19.8 MB   | ##8        |  28% 
    ...
    libstdcxx-devel_linu | 19.8 MB   | ###8       |  39% 
    ...
    sysroot_linux-64-2.3 | 40.1 MB   | ##4        |  25% 
    ...
    r-base-4.5.3         | 26.1 MB   | ###8       |  38% 
    sysroot_linux-64-2.3 | 40.1 MB   | ###        |  30% 


    libstdcxx-devel_linu | 19.8 MB   | ######4    |  65% 



    gfortran_impl_linux- | 19.1 MB   | ######5    |  65% 

    gcc_impl_linux-64-15 | 77.4 MB   | ##3        |  23% 
    sysroot_linux-64-2.3 | 40.1 MB   | ###6       |  36% 
    ...
    gfortran_impl_linux- | 19.1 MB   | #######8   |  78% 

    gcc_impl_linux-64-15 | 77.4 MB   | ##6        |  27% 
    sysroot_linux-64-2.3 | 40.1 MB   | ####2      |  42% 


    libstdcxx-devel_linu | 19.8 MB   | #########  |  91% 



    gfortran_impl_linux- | 19.1 MB   | #########3 |  94% 

    gcc_impl_linux-64-15 | 77.4 MB   | ###1       |  32% 
    sysroot_linux-64-2.3 | 40.1 MB   | #####      |  50% 

    gcc_impl_linux-64-15 | 77.4 MB   | ###6       |  36% 
    sysroot_linux-64-2.3 | 40.1 MB   | ######     |  61% 

    gcc_impl_linux-64-15 | 77.4 MB   | ####2      |  43% 
    gcc_impl_linux-64-15 | 77.4 MB   | ####8      |  49% 
    sysroot_linux-64-2.3 | 40.1 MB   | ########6  |  86% 


    gcc_impl_linux-64-15 | 77.4 MB   | #####4     |  55% 



    gfortran_impl_linux- | 19.1 MB   | ########## | 100% 
    sysroot_linux-64-2.3 | 40.1 MB   | #########8 |  98% 
    ...
    gxx_impl_linux-64-15 | 15.6 MB   | ####3      |  43% 
    ...
    gxx_impl_linux-64-15 | 15.6 MB   | ######2    |  62% 





    gcc_impl_linux-64-15 | 77.4 MB   | #######    |  70% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | #######8   |  79% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | ########3  |  83% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | ########7  |  87% 





    icu-78.3             | 12.1 MB   | ########## | 100% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | #########1 |  92% 
    ...
    libopenblas-0.3.33   | 5.7 MB    | ####7      |  48% 
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | #########9 |  99% 
    ...
    libgcc-devel_linux-6 | 3.0 MB    | ######6    |  66% 
    ...
    libgfortran5-15.2.0  | 2.4 MB    | ########2  |  82% 
    ...
    temp_benchmark_bafg0_x6/r_solver/solvers/r_pgd.py. Please fix the following 
    ...
    _get_module_from_file
      ...
      File 
    &quot;/home/circleci/project/examples/temp_benchmark_bafg0_x6/r_solver/solvers/r_pg
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_bafg0_x6/r_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_bafg0_x6/r_solver/outputs/benchopt_run_2026-07-22_13h33m51.parq</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">uet</span> 
    Rendering benchmark results...
       Processing 
    temp_benchmark_bafg0_x6/r_solver/outputs/benchopt_run_2026-07-22_13h33m51.parq
    uet
    done
    Writing results to 
    temp_benchmark_bafg0_x6/r_solver/outputs/r_solver_benchopt_run_2026-07-22_13h3
    3m51.html
    Writing r_solver index to 
    temp_benchmark_bafg0_x6/r_solver/outputs/r_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (2 minutes 25.160 seconds)
