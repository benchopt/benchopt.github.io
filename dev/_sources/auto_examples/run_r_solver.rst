...
.. raw:: html
    ...
    <input  id='example-benchmark-a30d83dc70364ea6898cbd208e147ecf-1' name='example-benchmark-a30d83dc70364ea6898cbd208e147ecf' type='radio'><label for='example-benchmark-a30d83dc70364ea6898cbd208e147ecf-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-a30d83dc70364ea6898cbd208e147ecf-2' name='example-benchmark-a30d83dc70364ea6898cbd208e147ecf' type='radio'><label for='example-benchmark-a30d83dc70364ea6898cbd208e147ecf-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-a30d83dc70364ea6898cbd208e147ecf-3' name='example-benchmark-a30d83dc70364ea6898cbd208e147ecf' type='radio'><label for='example-benchmark-a30d83dc70364ea6898cbd208e147ecf-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='r_solver.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-60f608c013484338b3255550a0f85d8b-0' name='example-benchmark-60f608c013484338b3255550a0f85d8b' type='radio'><label for='example-benchmark-60f608c013484338b3255550a0f85d8b-0'>solvers/r_pgd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">pathlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">Path</span>
    ...
    <input  id='example-benchmark-60f608c013484338b3255550a0f85d8b-1' name='example-benchmark-60f608c013484338b3255550a0f85d8b' type='radio'><label for='example-benchmark-60f608c013484338b3255550a0f85d8b-1'>solvers/r_pgd.R</label><div class='sd-tab-content'><div class="highlight"><pre><span></span>##&#39; Functions used in GD algorithm
    ##&#39;
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>install<span class="w"> </span>temp_benchmark_uyl6g2kp/r_solver<span class="w"> </span>-s<span class="w"> </span>r-pgd
    </pre></div>
    </pre>
    ...
    gcc_impl_linux-64-15 | 77.4 MB   | 9          |   9% [A
    sysroot_linux-64-2.3 | 40.1 MB   | 1          |   1% 

    r-base-4.5.3         | 26.1 MB   | #7         |  17% 


    libstdcxx-devel_linu | 19.8 MB   | #8         |  19% 
    ...
    r-base-4.5.3         | 26.1 MB   | ####3      |  43% 


    libstdcxx-devel_linu | 19.8 MB   | #####7     |  57% 



    gfortran_impl_linux- | 19.1 MB   | ###6       |  36% 
    sysroot_linux-64-2.3 | 40.1 MB   | ###2       |  32% 

    r-base-4.5.3         | 26.1 MB   | ######9    |  69% 
    ...
    gfortran_impl_linux- | 19.1 MB   | #########4 |  95% 
    ...
    gxx_impl_linux-64-15 | 15.6 MB   | ####7      |  48% 
    ...
    temp_benchmark_uyl6g2kp/r_solver/solvers/r_pgd.py. Please fix the following 
    ...
    _get_module_from_file
      ...
      File 
    &quot;/home/circleci/project/examples/temp_benchmark_uyl6g2kp/r_solver/solvers/r_pg
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_uyl6g2kp/r_solver<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">4</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_uyl6g2kp/r_solver/outputs/benchopt_run_2026-06-30_15h03m00.parq</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">uet</span> 
    Rendering benchmark results...
       Processing 
    temp_benchmark_uyl6g2kp/r_solver/outputs/benchopt_run_2026-06-30_15h03m00.parq
    uet
    done
    Writing results to 
    temp_benchmark_uyl6g2kp/r_solver/outputs/r_solver_benchopt_run_2026-06-30_15h0
    3m00.html
    Writing r_solver index to 
    temp_benchmark_uyl6g2kp/r_solver/outputs/r_solver.html
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 25.107 seconds)
