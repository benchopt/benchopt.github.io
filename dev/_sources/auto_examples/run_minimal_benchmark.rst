...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <input checked="checked" id='example-benchmark-debec17b1e87479c861d6afb90898763-0' name='example-benchmark-debec17b1e87479c861d6afb90898763' type='radio'><label for='example-benchmark-debec17b1e87479c861d6afb90898763-0'>objective.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseObjective</span>
    ...
    <input  id='example-benchmark-debec17b1e87479c861d6afb90898763-1' name='example-benchmark-debec17b1e87479c861d6afb90898763' type='radio'><label for='example-benchmark-debec17b1e87479c861d6afb90898763-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    ...
    <input  id='example-benchmark-debec17b1e87479c861d6afb90898763-2' name='example-benchmark-debec17b1e87479c861d6afb90898763' type='radio'><label for='example-benchmark-debec17b1e87479c861d6afb90898763-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-debec17b1e87479c861d6afb90898763-3' name='example-benchmark-debec17b1e87479c861d6afb90898763' type='radio'><label for='example-benchmark-debec17b1e87479c861d6afb90898763-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_dbobe3vk/minimal_benchmark<span class="w"> </span>-n<span class="w"> </span><span class="m">20</span><span class="w"> </span>-r<span class="w"> </span><span class="m">2</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_dbobe3vk/minimal_benchmark/outputs/benchopt_run_2026-04-29_20h1</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">4m05.parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_dbobe3vk/minimal_benchmark/outputs/benchopt_run_2026-04-29_20h1
    4m05.parquet
    done
    Writing results to 
    temp_benchmark_dbobe3vk/minimal_benchmark/outputs/minimal_benchmark_benchopt_r
    un_2026-04-29_20h14m05.html
    Writing minimal_benchmark index to 
    temp_benchmark_dbobe3vk/minimal_benchmark/outputs/minimal_benchmark.html
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>run<span class="w"> </span>temp_benchmark_dbobe3vk/minimal_benchmark<span class="w"> </span>-n<span class="w"> </span><span class="m">30</span><span class="w"> </span>-r<span class="w"> </span><span class="m">5</span>
    </pre></div>
    </pre>
    ...
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">Saving result in: </span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">temp_benchmark_dbobe3vk/minimal_benchmark/outputs/benchopt_run_2026-04-29_20h1</span>
    <span style="color: #008000; text-decoration-color: #008000; font-weight: bold">4m11.parquet</span>
    Rendering benchmark results...
       Processing 
    temp_benchmark_dbobe3vk/minimal_benchmark/outputs/benchopt_run_2026-04-29_20h1
    4m11.parquet
