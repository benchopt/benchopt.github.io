...
.. raw:: html
    ...
    <input  id='example-benchmark-5b5d91d822c34e76a5318bd1d7dff393-1' name='example-benchmark-5b5d91d822c34e76a5318bd1d7dff393' type='radio'><label for='example-benchmark-5b5d91d822c34e76a5318bd1d7dff393-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-5b5d91d822c34e76a5318bd1d7dff393-2' name='example-benchmark-5b5d91d822c34e76a5318bd1d7dff393' type='radio'><label for='example-benchmark-5b5d91d822c34e76a5318bd1d7dff393-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-5b5d91d822c34e76a5318bd1d7dff393-3' name='example-benchmark-5b5d91d822c34e76a5318bd1d7dff393' type='radio'><label for='example-benchmark-5b5d91d822c34e76a5318bd1d7dff393-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>prepare<span class="w"> </span>temp_benchmark_hzp0db9r/prepare_example
    </pre></div>
    </pre>
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    <p>We now update the following files:</p><br/>
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='prepare_example.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-8ee263b35c3b485995bad37c3596c65c-0' name='example-benchmark-8ee263b35c3b485995bad37c3596c65c' type='radio'><label for='example-benchmark-8ee263b35c3b485995bad37c3596c65c-0'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
