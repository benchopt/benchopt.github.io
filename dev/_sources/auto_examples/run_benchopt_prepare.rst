...
.. raw:: html
    ...
    <input  id='example-benchmark-b581a7d9893b4df6a8d16a3cd11caa7e-1' name='example-benchmark-b581a7d9893b4df6a8d16a3cd11caa7e' type='radio'><label for='example-benchmark-b581a7d9893b4df6a8d16a3cd11caa7e-1'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-b581a7d9893b4df6a8d16a3cd11caa7e-2' name='example-benchmark-b581a7d9893b4df6a8d16a3cd11caa7e' type='radio'><label for='example-benchmark-b581a7d9893b4df6a8d16a3cd11caa7e-2'>solvers/gd.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseSolver</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
    ...
    <input  id='example-benchmark-b581a7d9893b4df6a8d16a3cd11caa7e-3' name='example-benchmark-b581a7d9893b4df6a8d16a3cd11caa7e' type='radio'><label for='example-benchmark-b581a7d9893b4df6a8d16a3cd11caa7e-3'>config.yml</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="c1">#loaded from minimal_benchmark/config.yml</span>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                <pre class="code-cell-equiv"><div class="highlight"><pre><span></span><span class="gp">$ </span>benchopt<span class="w"> </span>prepare<span class="w"> </span>temp_benchmark_84bce4kb/prepare_example
    </pre></div>
    </pre>
...
.. raw:: html
    ...
    <div class="output_subarea output_html rendered_html output_result">
                ...
                <div class="sphx-glr-script-out highlight-none notranslate">
                    <div class="highlight"><pre>Preparing datasets for benchmark &#x27;prepare_example&#x27;
    No seed was specified. Selected global seed: 0
    Preparing simulated[n_samples=100] ... done<span style="color: #008080; text-decoration-color: #008080; font-weight: bold"> (cached)</span>
    Preparing simulated[n_samples=1000] ... done<span style="color: #008080; text-decoration-color: #008080; font-weight: bold"> (cached)</span>
    Summary: 2/2 datasets ready.
...
.. raw:: html
    ...
    <pre class="code-cell-equiv">            <div class='display_example_benchmark'>
                    ...
                    <div class='sd-tab-set'>
                        <label onclick="var a=document.createElement('a');a.href='data:application/zip;base64,';a.download='prepare_example.zip';document.body.appendChild(a);a.click();document.body.removeChild(a);">&#x2B07; Download</label><div style='order:0;flex-basis:100%;height:0;overflow:hidden'></div>
                        <input checked="checked" id='example-benchmark-702abcb75be349e68b0ce614a3641bdc-0' name='example-benchmark-702abcb75be349e68b0ce614a3641bdc' type='radio'><label for='example-benchmark-702abcb75be349e68b0ce614a3641bdc-0'>datasets/simulated.py</label><div class='sd-tab-content'><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">benchopt</span><span class="w"> </span><span class="kn">import</span> <span class="n">BaseDataset</span>
    <span class="kn">import</span><span class="w"> </span><span class="nn">numpy</span><span class="w"> </span><span class="k">as</span><span class="w"> </span><span class="nn">np</span>
